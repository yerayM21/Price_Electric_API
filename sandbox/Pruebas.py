from ..src.screaper.extraer_tabla import GetsUrls
import requests
import re
import time
import json
                ...
                for Month_value, Month_text in Month_options.items():
                    ...
                    while retry_attempts > 0:
                        try:
                            ...
                            if season_table:
                                if Month_text not in data[Year_text][Summer_Month_text]:
                            ...
                            break  # Si la operación tuvo éxito, salir del bucle
                        except StaleElementReferenceException:
                            retry_attempts -= 1
                            print(f'Elemento obsoleto encontrado. Reintentando la selección para año {Year_text}, mes cae el verano {Summer_Month_text} y mes {Month_text}. Intentos restantes: {retry_attempts}')
